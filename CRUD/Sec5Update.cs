...
namespace CRUD
{
    public partial class Sec5Update : Form
    {
        public Sec5Update()
        {
            InitializeComponent();
        ...
        private void Sec5Update_Load(object sender, EventArgs e)
        {
        ...
        private void Sec5Update_FormClosing(object sender, FormClosingEventArgs e)
        {
            this.Hide();
        ...
        private void updateBtn_Click(object sender, EventArgs e)
        {
            if (ID > 0)
            {
                SqlCommand cmd = new SqlCommand("UPDATE Sec5 SET FirstName = @FirstName, LastName = @LastName, MiddleName = @MiddleName, StudentNum =  @StudentNum,emailAdd = @emailAdd,contactNum = @contactNum WHERE id = @ID", conn);
