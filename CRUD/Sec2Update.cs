...
namespace CRUD
{
    public partial class Sec2Update : Form
    {
        public Sec2Update()
        {
            InitializeComponent();
        ...
        private void Sec2Update_Load(object sender, EventArgs e)
        {
        ...
        private void Sec2Update_FormClosing(object sender, FormClosingEventArgs e)
        {
            this.Hide();
        ...
        private void updateBtn_Click(object sender, EventArgs e)
        {
            if (ID > 0)
            {
                SqlCommand cmd = new SqlCommand("UPDATE Sec2 SET FirstName = @FirstName, LastName = @LastName, MiddleName = @MiddleName, StudentNum =  @StudentNum,emailAdd = @emailAdd,contactNum = @contactNum WHERE id = @ID", conn);
